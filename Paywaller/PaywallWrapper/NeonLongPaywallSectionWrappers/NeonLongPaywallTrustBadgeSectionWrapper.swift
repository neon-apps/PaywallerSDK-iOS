//
//  NeonLongPaywallTrustBadgeSectionWrapper.swift
...
extension NeonLongPaywallJSONWrapper {
    ...
    static func trustBadgeTypeFromString(_ typeString: String, fromDict dict: [String: Any]) -> NeonLongPaywallTrustBadgeType? {
        switch typeString {
        case "laurelWreath":
