//
//  PaywallerPaywallWhatYouWillGetView.swift
...
@available(iOS 15.0, *)
class PaywallerPaywallTimelineView : BasePaywallerPaywallSectionView{
    ...
    func configureLineView(){
        ...
        if itemsStackView.subviews.count < 2{
            ErrorManager.showWarning(title: "Ops!", subtitle: "You have to add at least 2 items to use timeline section.")
            return
        }
    ...
    private func addItem(_ item: PaywallerPaywallTimelineItem) {
        let itemView = UIView()
