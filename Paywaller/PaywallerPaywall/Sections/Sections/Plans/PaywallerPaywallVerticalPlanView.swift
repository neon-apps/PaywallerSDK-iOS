//
//  PaywallerPaywallVerticlPlanView.swift
...
@available(iOS 15.0, *)
class PaywallerPaywallVerticalPlanView : UIView, AdaptyManagerDelegate{
    ...
    var plan : PaywallerPaywallPlan? = nil{
        didSet{
            packageFetched()
    ...
    var delegate : PaywallerPaywallPlanViewDelegate?
    
    init(paywallManager : PaywallerPaywallManager) {
    ...
    func adjustPlaceholderPrices(){
        ...
        durationLabel.text = plan.title ?? "{TYPE}"
