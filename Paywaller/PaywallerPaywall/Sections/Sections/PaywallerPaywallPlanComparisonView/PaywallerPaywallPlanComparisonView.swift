...
@available(iOS 15.0, *)
class PaywallerPaywallPlanComparisonView : BasePaywallerPaywallSectionView{
    ...
    private func addItem(_ item: PaywallerPaywallPlanComparisonItem) {
