//
//  PaywallerPaywallManagerTrustBadgeView.swift
...
@available(iOS 15.0, *)
class PaywallerPaywallTrustBadgeView : BasePaywallerPaywallSectionView{
...
public enum PaywallerPaywallTrustBadgeType{
